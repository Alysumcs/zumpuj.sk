...
(function () {
  ...
  (function heroBackground() {
    ...
    var LAYERS = [
      ...
      { amp: 18, len: 0.0042, sp: 0.00055, off: 0.945, c1: 'rgba(1,78,117,.55)',  c2: 'rgba(1,78,117,0)' },
      { amp: 14, len: 0.0060, sp: 0.00085, off: 0.968, c1: 'rgba(1,136,204,.42)', c2: 'rgba(1,136,204,0)' },
      { amp: 10, len: 0.0090, sp: 0.00130, off: 0.988, c1: 'rgba(53,214,255,.28)', c2: 'rgba(53,214,255,0)' }
    ];
    ...
    function drawWaves() {
      for (var i = 0; i < LAYERS.length; i++) {
        ...
        ctx.strokeStyle = 'rgba(53,214,255,' + (0.10 + i * 0.06) + ')';
        ctx.lineWidth = 1;
        ctx.stroke();
      }
    }
    ...
    function drawParticles() {
      for (var i = 0; i < particles.length; i++) {
        ...
        ctx.fillStyle = 'rgba(160,220,255,' + p.a + ')';
        ctx.fill();
      }
    }
    ...
    function drawBubbles() {
      for (var i = 0; i < bubbles.length; i++) {
        ...
        ctx.strokeStyle = 'rgba(53,214,255,.22)';
        ctx.lineWidth = 1;
        ctx.stroke();
      }
    }
    ...
    function drawRipples() {
      for (var i = ripples.length - 1; i >= 0; i--) {
        ...
        ctx.strokeStyle = 'rgba(53,214,255,' + r.a + ')';
        ctx.lineWidth = 1.2;
        ctx.stroke();
      }
    }
  ...
  (function tankSim() {
    ...
    function draw() {
      ...
      ctx.strokeStyle = 'rgba(243,246,248,.05)';
      ctx.lineWidth = 1;
      ...
      ctx.fillStyle = 'rgba(243,246,248,.28)';
      ...
      g.addColorStop(0, warn ? 'rgba(255,138,61,.85)' : 'rgba(53,214,255,.75)');
      g.addColorStop(1, warn ? 'rgba(180,60,10,.85)' : 'rgba(1,78,117,.9)');
      ctx.fillStyle = g;
      ctx.fill();
      ...
      ctx.fillStyle = 'rgba(201,255,77,.18)';
      ctx.strokeStyle = 'rgba(201,255,77,.8)';
      ctx.fill(); ctx.stroke();

      /* LED */
      var blink = 0.45 + Math.abs(Math.sin(t * 0.035)) * 0.55;
      ctx.beginPath(); ctx.arc(sx, sy - 8, 3.2, 0, 6.2832);
      ctx.fillStyle = 'rgba(201,255,77,' + blink + ')';
      ctx.fill();
      ...
      ctx.strokeStyle = 'rgba(201,255,77,.75)';
      ctx.lineWidth = 1.6;
      ...
      ctx.strokeStyle = 'rgba(201,255,77,' + (0.4 * (1 - pingR / 46)) + ')';
      ctx.lineWidth = 1.4;
      ctx.stroke();
      ...
      /* varovný pruh */
      if (warn) {
        ctx.fillStyle = 'rgba(255,138,61,.10)';
